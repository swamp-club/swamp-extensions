// Auto-generated extension model for @swamp/gcp/dfareporting/orders
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Campaign Manager 360 Orders.
 *
...
const StateSchema = z.object({
  ...
  approverUserProfileIds: z.array(z.string()).optional(),
  buyerInvoiceId: z.string().optional(),
  buyerOrganizationName: z.string().optional(),
  ...
  contacts: z.array(z.object({
    ...
    signatureUserProfileId: z.string(),
  })).optional(),
  id: z.string(),
  ...
  planningTermId: z.string().optional(),
  projectId: z.string().optional(),
  sellerOrderId: z.string().optional(),
  sellerOrganizationName: z.string().optional(),
...
/** Swamp extension model for Google Cloud Campaign Manager 360 Orders. Registered at `@swamp/gcp/dfareporting/orders`. */
export const model = {
  type: "@swamp/gcp/dfareporting/orders",
  ...
  methods: {
    get: {
      ...
      arguments: z.object({
        identifier: z.string().describe("The id of the orders"),
      }),
    ...
    list: {
      description: "List orders resources",
      arguments: z.object({
        ids: z.string().describe("Select only orders with these IDs.")
          .optional(),
