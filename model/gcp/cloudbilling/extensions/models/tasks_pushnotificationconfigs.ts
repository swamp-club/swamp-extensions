...
// Auto-generated extension model for @swamp/gcp/cloudbilling/tasks-pushnotificationconfigs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Billing Tasks.PushNotificationConfigs.
 *
...
/** Swamp extension model for Google Cloud Billing Tasks.PushNotificationConfigs. Registered at `@swamp/gcp/cloudbilling/tasks-pushnotificationconfigs`. */
export const model = {
  type: "@swamp/gcp/cloudbilling/tasks-pushnotificationconfigs",
