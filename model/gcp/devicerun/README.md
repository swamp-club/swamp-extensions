...
Google Cloud devicerun resources.
...
Use `swamp model type describe @swamp/gcp/devicerun/devices` to see the full
...
swamp model create @swamp/gcp/devicerun/devices my-devices
