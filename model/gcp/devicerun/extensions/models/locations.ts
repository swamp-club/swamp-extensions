...
// Auto-generated extension model for @swamp/gcp/devicerun/locations
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Device Run Locations.
 *
...
const GET_CONFIG = {
  "id": "devicerun.projects.locations.get",
  "path": "v1alpha/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "devicerun.projects.locations.list",
...
/** Swamp extension model for Google Cloud Device Run Locations. Registered at `@swamp/gcp/devicerun/locations`. */
export const model = {
  type: "@swamp/gcp/devicerun/locations",
