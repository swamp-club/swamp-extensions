...
Use
`swamp model type describe @swamp/aws/arczonalshift/autoshift_observer_notification_status`
...
```bash
# Create a new autoshift_observer_notification_status model
swamp model create @swamp/aws/arczonalshift/autoshift_observer_notification_status my-autoshift_observer_notification_status

# Edit the model to configure its properties
swamp model edit my-autoshift_observer_notification_status

# Create the resource in AWS
swamp model method run my-autoshift_observer_notification_status create

# Sync current state from AWS
swamp model method run my-autoshift_observer_notification_status sync
```
