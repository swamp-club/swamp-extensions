...
Use `swamp model type describe @swamp/aws/bedrock/agent_alias` to see the full
...
```bash
# Create a new agent_alias model
swamp model create @swamp/aws/bedrock/agent_alias my-agent_alias

# Edit the model to configure its properties
swamp model edit my-agent_alias

# Create the resource in AWS
swamp model method run my-agent_alias create

# Sync current state from AWS
swamp model method run my-agent_alias sync
```
