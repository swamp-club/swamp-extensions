...
Use `swamp model type describe @swamp/aws/mwaaserverless/workflow` to see the
...
swamp model create @swamp/aws/mwaaserverless/workflow my-workflow

# Edit the model to configure its properties
swamp model edit my-workflow

# Create the resource in AWS
swamp model method run my-workflow create

# Sync current state from AWS
swamp model method run my-workflow sync
```
