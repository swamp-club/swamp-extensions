...
Use `swamp model type describe @swamp/aws/eventschemas/discoverer` to see the
...
```bash
# Create a new discoverer model
swamp model create @swamp/aws/eventschemas/discoverer my-discoverer

# Edit the model to configure its properties
swamp model edit my-discoverer

# Create the resource in AWS
swamp model method run my-discoverer create

# Sync current state from AWS
swamp model method run my-discoverer sync
```
