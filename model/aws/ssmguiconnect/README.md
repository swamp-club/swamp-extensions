...
Use `swamp model type describe @swamp/aws/ssmguiconnect/preferences` to see the
...
```bash
# Create a new preferences model
swamp model create @swamp/aws/ssmguiconnect/preferences my-preferences

# Edit the model to configure its properties
swamp model edit my-preferences

# Create the resource in AWS
swamp model method run my-preferences create

# Sync current state from AWS
swamp model method run my-preferences sync
```
