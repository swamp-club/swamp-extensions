...
Use `swamp model type describe @swamp/aws/autoscaling/auto_scaling_group` to see
...
```bash
# Create a new auto_scaling_group model
swamp model create @swamp/aws/autoscaling/auto_scaling_group my-auto_scaling_group

# Edit the model to configure its properties
swamp model edit my-auto_scaling_group

# Create the resource in AWS
swamp model method run my-auto_scaling_group create

# Sync current state from AWS
swamp model method run my-auto_scaling_group sync
```
