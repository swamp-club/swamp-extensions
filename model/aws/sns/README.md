...
Use `swamp model type describe @swamp/aws/sns/topic` to see the full list of
...
swamp model create @swamp/aws/sns/topic my-topic

# Edit the model to configure its properties
swamp model edit my-topic

# Create the resource in AWS
swamp model method run my-topic create

# Sync current state from AWS
swamp model method run my-topic sync
```
