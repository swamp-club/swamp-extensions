...
Use `swamp model type describe @swamp/aws/datasync/agent` to see the full list
...
swamp model create @swamp/aws/datasync/agent my-agent

# Edit the model to configure its properties
swamp model edit my-agent

# Create the resource in AWS
swamp model method run my-agent create

# Sync current state from AWS
swamp model method run my-agent sync
```
