...
Use `swamp model type describe @swamp/aws/cur/report_definition` to see the full
...
```bash
# Create a new report_definition model
swamp model create @swamp/aws/cur/report_definition my-report_definition

# Edit the model to configure its properties
swamp model edit my-report_definition

# Create the resource in AWS
swamp model method run my-report_definition create

# Sync current state from AWS
swamp model method run my-report_definition sync
```
