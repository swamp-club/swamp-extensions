...
Use
`swamp model type describe @swamp/aws/acmpca/certificate_authority_activation`
...
```bash
# Create a new certificate_authority_activation model
swamp model create @swamp/aws/acmpca/certificate_authority_activation my-certificate_authority_activation

# Edit the model to configure its properties
swamp model edit my-certificate_authority_activation

# Create the resource in AWS
swamp model method run my-certificate_authority_activation create

# Sync current state from AWS
swamp model method run my-certificate_authority_activation sync
```
