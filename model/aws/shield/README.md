...
Use `swamp model type describe @swamp/aws/shield/drtaccess` to see the full list
...
```bash
# Create a new drtaccess model
swamp model create @swamp/aws/shield/drtaccess my-drtaccess

# Edit the model to configure its properties
swamp model edit my-drtaccess

# Create the resource in AWS
swamp model method run my-drtaccess create

# Sync current state from AWS
swamp model method run my-drtaccess sync
```
