...
Use `swamp model type describe @swamp/aws/iot/account_audit_configuration` to
...
```bash
# Create a new account_audit_configuration model
swamp model create @swamp/aws/iot/account_audit_configuration my-account_audit_configuration

# Edit the model to configure its properties
swamp model edit my-account_audit_configuration

# Create the resource in AWS
swamp model method run my-account_audit_configuration create

# Sync current state from AWS
swamp model method run my-account_audit_configuration sync
```
