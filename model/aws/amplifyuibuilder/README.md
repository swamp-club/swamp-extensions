...
Use `swamp model type describe @swamp/aws/amplifyuibuilder/component` to see the
...
swamp model create @swamp/aws/amplifyuibuilder/component my-component
