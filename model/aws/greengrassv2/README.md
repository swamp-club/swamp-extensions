...
Use `swamp model type describe @swamp/aws/greengrassv2/component_version` to see
...
```bash
# Create a new component_version model
swamp model create @swamp/aws/greengrassv2/component_version my-component_version

# Edit the model to configure its properties
swamp model edit my-component_version

# Create the resource in AWS
swamp model method run my-component_version create

# Sync current state from AWS
swamp model method run my-component_version sync
```
