...
Use
`swamp model type describe @swamp/aws/codegurureviewer/repository_association`
...
```bash
# Create a new repository_association model
swamp model create @swamp/aws/codegurureviewer/repository_association my-repository_association

# Edit the model to configure its properties
swamp model edit my-repository_association

# Create the resource in AWS
swamp model method run my-repository_association create

# Sync current state from AWS
swamp model method run my-repository_association sync
```
