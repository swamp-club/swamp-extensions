...
Use `swamp model type describe @swamp/aws/connect/agent_status` to see the full
...
```bash
# Create a new agent_status model
swamp model create @swamp/aws/connect/agent_status my-agent_status

# Edit the model to configure its properties
swamp model edit my-agent_status

# Create the resource in AWS
swamp model method run my-agent_status create

# Sync current state from AWS
swamp model method run my-agent_status sync
```
