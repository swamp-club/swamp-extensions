...
Use `swamp model type describe @swamp/aws/odb/cloud_autonomous_vm_cluster` to
...
```bash
# Create a new cloud_autonomous_vm_cluster model
swamp model create @swamp/aws/odb/cloud_autonomous_vm_cluster my-cloud_autonomous_vm_cluster

# Edit the model to configure its properties
swamp model edit my-cloud_autonomous_vm_cluster

# Create the resource in AWS
swamp model method run my-cloud_autonomous_vm_cluster create

# Sync current state from AWS
swamp model method run my-cloud_autonomous_vm_cluster sync
```
