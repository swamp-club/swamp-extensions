...
AWS ROUTE53RECOVERYCONTROL resources.
...
Use `swamp model type describe @swamp/aws/route53recoverycontrol/cluster` to see
...
swamp model create @swamp/aws/route53recoverycontrol/cluster my-cluster
