...
Use `swamp model type describe @swamp/aws/workspacesweb/browser_settings` to see
...
```bash
# Create a new browser_settings model
swamp model create @swamp/aws/workspacesweb/browser_settings my-browser_settings

# Edit the model to configure its properties
swamp model edit my-browser_settings

# Create the resource in AWS
swamp model method run my-browser_settings create

# Sync current state from AWS
swamp model method run my-browser_settings sync
```
