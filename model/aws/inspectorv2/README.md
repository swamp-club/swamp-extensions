...
Use `swamp model type describe @swamp/aws/inspectorv2/cis_scan_configuration` to
...
```bash
# Create a new cis_scan_configuration model
swamp model create @swamp/aws/inspectorv2/cis_scan_configuration my-cis_scan_configuration

# Edit the model to configure its properties
swamp model edit my-cis_scan_configuration

# Create the resource in AWS
swamp model method run my-cis_scan_configuration create

# Sync current state from AWS
swamp model method run my-cis_scan_configuration sync
```
