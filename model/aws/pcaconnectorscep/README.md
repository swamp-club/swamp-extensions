...
Use `swamp model type describe @swamp/aws/pcaconnectorscep/challenge` to see the
...
swamp model create @swamp/aws/pcaconnectorscep/challenge my-challenge

# Edit the model to configure its properties
swamp model edit my-challenge

# Create the resource in AWS
swamp model method run my-challenge create

# Sync current state from AWS
swamp model method run my-challenge sync
```
