...
Use `swamp model type describe @swamp/aws/paymentcryptography/alias` to see the
...
```bash
# Create a new alias model
swamp model create @swamp/aws/paymentcryptography/alias my-alias

# Edit the model to configure its properties
swamp model edit my-alias

# Create the resource in AWS
swamp model method run my-alias create

# Sync current state from AWS
swamp model method run my-alias sync
```
