...
Use `swamp model type describe @swamp/aws/entityresolution/id_mapping_workflow`
...
```bash
# Create a new id_mapping_workflow model
swamp model create @swamp/aws/entityresolution/id_mapping_workflow my-id_mapping_workflow

# Edit the model to configure its properties
swamp model edit my-id_mapping_workflow

# Create the resource in AWS
swamp model method run my-id_mapping_workflow create

# Sync current state from AWS
swamp model method run my-id_mapping_workflow sync
```
