...
Use `swamp model type describe @swamp/aws/controltower/enabled_baseline` to see
...
```bash
# Create a new enabled_baseline model
swamp model create @swamp/aws/controltower/enabled_baseline my-enabled_baseline

# Edit the model to configure its properties
swamp model edit my-enabled_baseline

# Create the resource in AWS
swamp model method run my-enabled_baseline create

# Sync current state from AWS
swamp model method run my-enabled_baseline sync
```
