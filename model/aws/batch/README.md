...
Use `swamp model type describe @swamp/aws/batch/compute_environment` to see the
...
```bash
# Create a new compute_environment model
swamp model create @swamp/aws/batch/compute_environment my-compute_environment

# Edit the model to configure its properties
swamp model edit my-compute_environment

# Create the resource in AWS
swamp model method run my-compute_environment create

# Sync current state from AWS
swamp model method run my-compute_environment sync
```
