...
Use `swamp model type describe @swamp/aws/oam/link` to see the full list of
...
swamp model create @swamp/aws/oam/link my-link

# Edit the model to configure its properties
swamp model edit my-link

# Create the resource in AWS
swamp model method run my-link create

# Sync current state from AWS
swamp model method run my-link sync
```
