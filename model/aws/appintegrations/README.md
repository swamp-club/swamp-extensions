...
Use `swamp model type describe @swamp/aws/appintegrations/application` to see
...
swamp model create @swamp/aws/appintegrations/application my-application
