...
Use `swamp model type describe @swamp/aws/omics/annotation_store` to see the
...
```bash
# Create a new annotation_store model
swamp model create @swamp/aws/omics/annotation_store my-annotation_store

# Edit the model to configure its properties
swamp model edit my-annotation_store

# Create the resource in AWS
swamp model method run my-annotation_store create

# Sync current state from AWS
swamp model method run my-annotation_store sync
```
