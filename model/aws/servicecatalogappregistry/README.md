...
Use `swamp model type describe @swamp/aws/servicecatalogappregistry/application`
...
swamp model create @swamp/aws/servicecatalogappregistry/application my-application
