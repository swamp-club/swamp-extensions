...
Use `swamp model type describe @swamp/aws/apprunner/auto_scaling_configuration`
...
```bash
# Create a new auto_scaling_configuration model
swamp model create @swamp/aws/apprunner/auto_scaling_configuration my-auto_scaling_configuration

# Edit the model to configure its properties
swamp model edit my-auto_scaling_configuration

# Create the resource in AWS
swamp model method run my-auto_scaling_configuration create

# Sync current state from AWS
swamp model method run my-auto_scaling_configuration sync
```
