...
Use `swamp model type describe @swamp/aws/vpclattice/access_log_subscription` to
...
```bash
# Create a new access_log_subscription model
swamp model create @swamp/aws/vpclattice/access_log_subscription my-access_log_subscription

# Edit the model to configure its properties
swamp model edit my-access_log_subscription

# Create the resource in AWS
swamp model method run my-access_log_subscription create

# Sync current state from AWS
swamp model method run my-access_log_subscription sync
```
