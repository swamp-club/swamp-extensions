...
Use `swamp model type describe @swamp/aws/resourcegroups/group` to see the full
...
swamp model create @swamp/aws/resourcegroups/group my-group

# Edit the model to configure its properties
swamp model edit my-group

# Create the resource in AWS
swamp model method run my-group create

# Sync current state from AWS
swamp model method run my-group sync
```
