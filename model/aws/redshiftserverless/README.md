...
AWS REDSHIFTSERVERLESS resources.
...
Use `swamp model type describe @swamp/aws/redshiftserverless/namespace` to see
...
```bash
# Create a new namespace model
swamp model create @swamp/aws/redshiftserverless/namespace my-namespace

# Edit the model to configure its properties
swamp model edit my-namespace

# Create the resource in AWS
swamp model method run my-namespace create

# Sync current state from AWS
swamp model method run my-namespace sync
```
