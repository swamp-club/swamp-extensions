...
Use `swamp model type describe @swamp/aws/signer/profile_permission` to see the
...
```bash
# Create a new profile_permission model
swamp model create @swamp/aws/signer/profile_permission my-profile_permission

# Edit the model to configure its properties
swamp model edit my-profile_permission

# Create the resource in AWS
swamp model method run my-profile_permission create

# Sync current state from AWS
swamp model method run my-profile_permission sync
```
