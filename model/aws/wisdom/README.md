...
Use `swamp model type describe @swamp/aws/wisdom/aiagent_version` to see the
...
```bash
# Create a new aiagent_version model
swamp model create @swamp/aws/wisdom/aiagent_version my-aiagent_version

# Edit the model to configure its properties
swamp model edit my-aiagent_version

# Create the resource in AWS
swamp model method run my-aiagent_version create

# Sync current state from AWS
swamp model method run my-aiagent_version sync
```
