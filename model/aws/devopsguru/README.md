...
Use
`swamp model type describe @swamp/aws/devopsguru/log_anomaly_detection_integration`
...
```bash
# Create a new log_anomaly_detection_integration model
swamp model create @swamp/aws/devopsguru/log_anomaly_detection_integration my-log_anomaly_detection_integration

# Edit the model to configure its properties
swamp model edit my-log_anomaly_detection_integration

# Create the resource in AWS
swamp model method run my-log_anomaly_detection_integration create

# Sync current state from AWS
swamp model method run my-log_anomaly_detection_integration sync
```
