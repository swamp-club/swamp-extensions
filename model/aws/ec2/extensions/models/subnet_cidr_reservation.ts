...
// Auto-generated extension model for @swamp/aws/ec2/subnet-cidr-reservation
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for EC2 SubnetCidrReservation (AWS::EC2::SubnetCidrReservation).
 *
...
const TagSchema = z.object({
  Key: z.string().min(1).max(128).regex(new RegExp("^(?![aA][wW][sS]:).+$"))
    .describe(
...
const GlobalArgsSchema = z.object({
  ...
  ReservationType: z.enum(["prefix", "explicit"]).describe(
...
const StateSchema = z.object({
  ...
  SubnetCidrReservationId: z.string(),
  SubnetId: z.string(),
...
/** Swamp extension model for EC2 SubnetCidrReservation. Registered at `@swamp/aws/ec2/subnet-cidr-reservation`. */
export const model = {
  type: "@swamp/aws/ec2/subnet-cidr-reservation",
  version: "2026.09.22.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "EC2 SubnetCidrReservation resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a EC2 SubnetCidrReservation",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a EC2 SubnetCidrReservation",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the EC2 SubnetCidrReservation",
        ),
      }),
    ...
    update: {
      description: "Update a EC2 SubnetCidrReservation",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
        ...
        const idParts = [
          ...
          existing.SubnetCidrReservationId?.toString(),
        ];
        if (idParts.some((p) => !p)) {
          throw new Error(
        ...
        const result = await updateResource(
          ...
          currentState,
          desiredState,
          ["SubnetId", "Cidr", "ReservationType", "Description"],
          credentials,
        );
        const handle = await context.writeResource(
          "state",
    ...
    delete: {
      description: "Delete a EC2 SubnetCidrReservation",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the EC2 SubnetCidrReservation",
        ),
    ...
    sync: {
      description: "Sync EC2 SubnetCidrReservation state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List EC2 SubnetCidrReservation resources",
      arguments: z.object({
