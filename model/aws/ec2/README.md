...
Use `swamp model type describe @swamp/aws/ec2/vpc` to see the full list of
...
```bash
# Create a new vpc model
swamp model create @swamp/aws/ec2/vpc my-vpc

# Edit the model to configure its properties
swamp model edit my-vpc

# Create the resource in AWS
swamp model method run my-vpc create

# Sync current state from AWS
swamp model method run my-vpc sync
```
