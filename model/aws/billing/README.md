...
Use `swamp model type describe @swamp/aws/billing/billing_view` to see the full
...
```bash
# Create a new billing_view model
swamp model create @swamp/aws/billing/billing_view my-billing_view

# Edit the model to configure its properties
swamp model edit my-billing_view

# Create the resource in AWS
swamp model method run my-billing_view create

# Sync current state from AWS
swamp model method run my-billing_view sync
```
