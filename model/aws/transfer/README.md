...
Use `swamp model type describe @swamp/aws/transfer/agreement` to see the full
...
```bash
# Create a new agreement model
swamp model create @swamp/aws/transfer/agreement my-agreement

# Edit the model to configure its properties
swamp model edit my-agreement

# Create the resource in AWS
swamp model method run my-agreement create

# Sync current state from AWS
swamp model method run my-agreement sync
```
