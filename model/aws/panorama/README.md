...
Use `swamp model type describe @swamp/aws/panorama/application_instance` to see
...
```bash
# Create a new application_instance model
swamp model create @swamp/aws/panorama/application_instance my-application_instance

# Edit the model to configure its properties
swamp model edit my-application_instance

# Create the resource in AWS
swamp model method run my-application_instance create

# Sync current state from AWS
swamp model method run my-application_instance sync
```
