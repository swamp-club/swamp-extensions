...
Use `swamp model type describe @swamp/aws/mediaconnect/bridge_output` to see the
...
```bash
# Create a new bridge_output model
swamp model create @swamp/aws/mediaconnect/bridge_output my-bridge_output

# Edit the model to configure its properties
swamp model edit my-bridge_output

# Create the resource in AWS
swamp model method run my-bridge_output create

# Sync current state from AWS
swamp model method run my-bridge_output sync
```
