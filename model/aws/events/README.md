...
Use `swamp model type describe @swamp/aws/events/api_destination` to see the
...
```bash
# Create a new api_destination model
swamp model create @swamp/aws/events/api_destination my-api_destination

# Edit the model to configure its properties
swamp model edit my-api_destination

# Create the resource in AWS
swamp model method run my-api_destination create

# Sync current state from AWS
swamp model method run my-api_destination sync
```
