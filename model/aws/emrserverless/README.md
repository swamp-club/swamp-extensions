...
Use `swamp model type describe @swamp/aws/emrserverless/application` to see the
...
swamp model create @swamp/aws/emrserverless/application my-application
