...
AWS CUSTOMERPROFILES resources.
...
Use
`swamp model type describe @swamp/aws/customerprofiles/calculated_attribute_definition`
...
```bash
# Create a new calculated_attribute_definition model
swamp model create @swamp/aws/customerprofiles/calculated_attribute_definition my-calculated_attribute_definition

# Edit the model to configure its properties
swamp model edit my-calculated_attribute_definition

# Create the resource in AWS
swamp model method run my-calculated_attribute_definition create

# Sync current state from AWS
swamp model method run my-calculated_attribute_definition sync
```
