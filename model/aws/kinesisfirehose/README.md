...
Use `swamp model type describe @swamp/aws/kinesisfirehose/delivery_stream` to
...
```bash
# Create a new delivery_stream model
swamp model create @swamp/aws/kinesisfirehose/delivery_stream my-delivery_stream

# Edit the model to configure its properties
swamp model edit my-delivery_stream

# Create the resource in AWS
swamp model method run my-delivery_stream create

# Sync current state from AWS
swamp model method run my-delivery_stream sync
```
