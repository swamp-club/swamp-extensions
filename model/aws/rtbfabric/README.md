...
Use `swamp model type describe @swamp/aws/rtbfabric/inbound_external_link` to
...
```bash
# Create a new inbound_external_link model
swamp model create @swamp/aws/rtbfabric/inbound_external_link my-inbound_external_link

# Edit the model to configure its properties
swamp model edit my-inbound_external_link

# Create the resource in AWS
swamp model method run my-inbound_external_link create

# Sync current state from AWS
swamp model method run my-inbound_external_link sync
```
