...
Use `swamp model type describe @swamp/aws/appstream/app_block_builder` to see
...
```bash
# Create a new app_block_builder model
swamp model create @swamp/aws/appstream/app_block_builder my-app_block_builder

# Edit the model to configure its properties
swamp model edit my-app_block_builder

# Create the resource in AWS
swamp model method run my-app_block_builder create

# Sync current state from AWS
swamp model method run my-app_block_builder sync
```
