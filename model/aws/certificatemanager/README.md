...
Use `swamp model type describe @swamp/aws/certificatemanager/account` to see the
...
swamp model create @swamp/aws/certificatemanager/account my-account

# Edit the model to configure its properties
swamp model edit my-account

# Create the resource in AWS
swamp model method run my-account create

# Sync current state from AWS
swamp model method run my-account sync
```
