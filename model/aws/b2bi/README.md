...
Use `swamp model type describe @swamp/aws/b2bi/capability` to see the full list
...
```bash
# Create a new capability model
swamp model create @swamp/aws/b2bi/capability my-capability

# Edit the model to configure its properties
swamp model edit my-capability

# Create the resource in AWS
swamp model method run my-capability create

# Sync current state from AWS
swamp model method run my-capability sync
```
