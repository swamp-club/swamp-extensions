...
Use `swamp model type describe @swamp/aws/apptest/test_case` to see the full
...
```bash
# Create a new test_case model
swamp model create @swamp/aws/apptest/test_case my-test_case

# Edit the model to configure its properties
swamp model edit my-test_case

# Create the resource in AWS
swamp model method run my-test_case create

# Sync current state from AWS
swamp model method run my-test_case sync
```
