...
Use `swamp model type describe @swamp/aws/kms/key` to see the full list of
...
swamp model create @swamp/aws/kms/key my-key

# Edit the model to configure its properties
swamp model edit my-key

# Create the resource in AWS
swamp model method run my-key create

# Sync current state from AWS
swamp model method run my-key sync
```
