...
Use `swamp model type describe @swamp/aws/savingsplans/savings_plan` to see the
...
```bash
# Create a new savings_plan model
swamp model create @swamp/aws/savingsplans/savings_plan my-savings_plan

# Edit the model to configure its properties
swamp model edit my-savings_plan

# Create the resource in AWS
swamp model method run my-savings_plan create

# Sync current state from AWS
swamp model method run my-savings_plan sync
```
