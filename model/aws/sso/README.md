...
Use `swamp model type describe @swamp/aws/sso/application_assignment` to see the
...
```bash
# Create a new application_assignment model
swamp model create @swamp/aws/sso/application_assignment my-application_assignment

# Edit the model to configure its properties
swamp model edit my-application_assignment

# Create the resource in AWS
swamp model method run my-application_assignment create

# Sync current state from AWS
swamp model method run my-application_assignment sync
```
