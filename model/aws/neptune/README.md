...
Use `swamp model type describe @swamp/aws/neptune/dbcluster_parameter_group` to
...
swamp model create @swamp/aws/neptune/dbcluster_parameter_group my-dbcluster_parameter_group
