...
Use `swamp model type describe @swamp/aws/kendraranking/execution_plan` to see
...
```bash
# Create a new execution_plan model
swamp model create @swamp/aws/kendraranking/execution_plan my-execution_plan

# Edit the model to configure its properties
swamp model edit my-execution_plan

# Create the resource in AWS
swamp model method run my-execution_plan create

# Sync current state from AWS
swamp model method run my-execution_plan sync
```
