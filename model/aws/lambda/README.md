...
Use `swamp model type describe @swamp/aws/lambda/function` to see the full list
...
swamp model create @swamp/aws/lambda/function my-function

# Edit the model to configure its properties
swamp model edit my-function

# Create the resource in AWS
swamp model method run my-function create

# Sync current state from AWS
swamp model method run my-function sync
```
