...
Use `swamp model type describe @swamp/aws/dynamodb/global-table` to see the full
...
```bash
# Create a new global-table model
swamp model create @swamp/aws/dynamodb/global-table my-global-table

# Edit the model to configure its properties
swamp model edit my-global-table

# Create the resource in AWS
swamp model method run my-global-table create

# Sync current state from AWS
swamp model method run my-global-table sync
```
