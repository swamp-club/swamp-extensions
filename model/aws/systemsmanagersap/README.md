...
Use `swamp model type describe @swamp/aws/systemsmanagersap/application` to see
...
swamp model create @swamp/aws/systemsmanagersap/application my-application
