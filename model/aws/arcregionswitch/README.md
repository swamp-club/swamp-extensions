...
Use `swamp model type describe @swamp/aws/arcregionswitch/plan` to see the full
...
```bash
# Create a new plan model
swamp model create @swamp/aws/arcregionswitch/plan my-plan

# Edit the model to configure its properties
swamp model edit my-plan

# Create the resource in AWS
swamp model method run my-plan create

# Sync current state from AWS
swamp model method run my-plan sync
```
