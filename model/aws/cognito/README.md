...
Use `swamp model type describe @swamp/aws/cognito/user-pool` to see the full
...
```bash
# Create a new user-pool model
swamp model create @swamp/aws/cognito/user-pool my-user-pool

# Edit the model to configure its properties
swamp model edit my-user-pool

# Create the resource in AWS
swamp model method run my-user-pool create

# Sync current state from AWS
swamp model method run my-user-pool sync
```
