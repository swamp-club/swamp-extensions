...
Use `swamp model type describe @swamp/aws/controlcatalog/common_control` to see
...
```bash
# Create a new common_control model
swamp model create @swamp/aws/controlcatalog/common_control my-common_control

# Edit the model to configure its properties
swamp model edit my-common_control

# Create the resource in AWS
swamp model method run my-common_control create

# Sync current state from AWS
swamp model method run my-common_control sync
```
