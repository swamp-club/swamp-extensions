...
Use
`swamp model type describe @swamp/aws/codestarnotifications/notification_rule`
...
```bash
# Create a new notification_rule model
swamp model create @swamp/aws/codestarnotifications/notification_rule my-notification_rule

# Edit the model to configure its properties
swamp model edit my-notification_rule

# Create the resource in AWS
swamp model method run my-notification_rule create

# Sync current state from AWS
swamp model method run my-notification_rule sync
```
