...
Use `swamp model type describe @swamp/aws/mediapackage/asset` to see the full
...
swamp model create @swamp/aws/mediapackage/asset my-asset

# Edit the model to configure its properties
swamp model edit my-asset

# Create the resource in AWS
swamp model method run my-asset create

# Sync current state from AWS
swamp model method run my-asset sync
```
