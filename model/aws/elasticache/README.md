...
Use `swamp model type describe @swamp/aws/elasticache/serverless-cache` to see
...
```bash
# Create a new serverless-cache model
swamp model create @swamp/aws/elasticache/serverless-cache my-serverless-cache

# Edit the model to configure its properties
swamp model edit my-serverless-cache

# Create the resource in AWS
swamp model method run my-serverless-cache create

# Sync current state from AWS
swamp model method run my-serverless-cache sync
```
