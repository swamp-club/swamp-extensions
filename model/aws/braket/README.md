...
Use `swamp model type describe @swamp/aws/braket/spending_limit` to see the full
...
```bash
# Create a new spending_limit model
swamp model create @swamp/aws/braket/spending_limit my-spending_limit

# Edit the model to configure its properties
swamp model edit my-spending_limit

# Create the resource in AWS
swamp model method run my-spending_limit create

# Sync current state from AWS
swamp model method run my-spending_limit sync
```
