...
Use `swamp model type describe @swamp/aws/rds/dbinstance` to see the full list
...
```bash
# Create a new dbinstance model
swamp model create @swamp/aws/rds/dbinstance my-dbinstance

# Edit the model to configure its properties
swamp model edit my-dbinstance

# Create the resource in AWS
swamp model method run my-dbinstance create

# Sync current state from AWS
swamp model method run my-dbinstance sync
```
