...
Use `swamp model type describe @swamp/aws/networkmanager/connect_attachment` to
...
```bash
# Create a new connect_attachment model
swamp model create @swamp/aws/networkmanager/connect_attachment my-connect_attachment

# Edit the model to configure its properties
swamp model edit my-connect_attachment

# Create the resource in AWS
swamp model method run my-connect_attachment create

# Sync current state from AWS
swamp model method run my-connect_attachment sync
```
