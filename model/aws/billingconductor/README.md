...
AWS BILLINGCONDUCTOR resources.
...
Use `swamp model type describe @swamp/aws/billingconductor/billing_group` to see
...
```bash
# Create a new billing_group model
swamp model create @swamp/aws/billingconductor/billing_group my-billing_group

# Edit the model to configure its properties
swamp model edit my-billing_group

# Create the resource in AWS
swamp model method run my-billing_group create

# Sync current state from AWS
swamp model method run my-billing_group sync
```
