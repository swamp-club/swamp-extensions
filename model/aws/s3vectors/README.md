...
Use `swamp model type describe @swamp/aws/s3vectors/index` to see the full list
...
swamp model create @swamp/aws/s3vectors/index my-index

# Edit the model to configure its properties
swamp model edit my-index

# Create the resource in AWS
swamp model method run my-index create

# Sync current state from AWS
swamp model method run my-index sync
```
