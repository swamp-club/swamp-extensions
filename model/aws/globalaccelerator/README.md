...
AWS GLOBALACCELERATOR resources.
...
Use `swamp model type describe @swamp/aws/globalaccelerator/accelerator` to see
...
swamp model create @swamp/aws/globalaccelerator/accelerator my-accelerator

# Edit the model to configure its properties
swamp model edit my-accelerator

# Create the resource in AWS
swamp model method run my-accelerator create

# Sync current state from AWS
swamp model method run my-accelerator sync
```
