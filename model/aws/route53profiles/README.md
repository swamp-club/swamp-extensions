...
Use `swamp model type describe @swamp/aws/route53profiles/profile_association`
...
```bash
# Create a new profile_association model
swamp model create @swamp/aws/route53profiles/profile_association my-profile_association

# Edit the model to configure its properties
swamp model edit my-profile_association

# Create the resource in AWS
swamp model method run my-profile_association create

# Sync current state from AWS
swamp model method run my-profile_association sync
```
