...
AWS APPLICATIONSIGNALS resources.
...
Use `swamp model type describe @swamp/aws/applicationsignals/discovery` to see
...
```bash
# Create a new discovery model
swamp model create @swamp/aws/applicationsignals/discovery my-discovery

# Edit the model to configure its properties
swamp model edit my-discovery

# Create the resource in AWS
swamp model method run my-discovery create

# Sync current state from AWS
swamp model method run my-discovery sync
```
