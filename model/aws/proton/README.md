...
Use `swamp model type describe @swamp/aws/proton/environment_account_connection`
...
```bash
# Create a new environment_account_connection model
swamp model create @swamp/aws/proton/environment_account_connection my-environment_account_connection

# Edit the model to configure its properties
swamp model edit my-environment_account_connection

# Create the resource in AWS
swamp model method run my-environment_account_connection create

# Sync current state from AWS
swamp model method run my-environment_account_connection sync
```
