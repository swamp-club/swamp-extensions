...
Use `swamp model type describe @swamp/aws/invoicing/invoice_unit` to see the
...
```bash
# Create a new invoice_unit model
swamp model create @swamp/aws/invoicing/invoice_unit my-invoice_unit

# Edit the model to configure its properties
swamp model edit my-invoice_unit

# Create the resource in AWS
swamp model method run my-invoice_unit create

# Sync current state from AWS
swamp model method run my-invoice_unit sync
```
