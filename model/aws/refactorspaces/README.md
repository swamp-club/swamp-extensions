...
Use `swamp model type describe @swamp/aws/refactorspaces/application` to see the
...
swamp model create @swamp/aws/refactorspaces/application my-application
