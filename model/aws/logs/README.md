...
Use `swamp model type describe @swamp/aws/logs/account_policy` to see the full
...
```bash
# Create a new account_policy model
swamp model create @swamp/aws/logs/account_policy my-account_policy

# Edit the model to configure its properties
swamp model edit my-account_policy

# Create the resource in AWS
swamp model method run my-account_policy create

# Sync current state from AWS
swamp model method run my-account_policy sync
```
