...
Use `swamp model type describe @swamp/aws/lookoutequipment/inference_scheduler`
...
```bash
# Create a new inference_scheduler model
swamp model create @swamp/aws/lookoutequipment/inference_scheduler my-inference_scheduler

# Edit the model to configure its properties
swamp model edit my-inference_scheduler

# Create the resource in AWS
swamp model method run my-inference_scheduler create

# Sync current state from AWS
swamp model method run my-inference_scheduler sync
```
