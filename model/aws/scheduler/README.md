...
Use `swamp model type describe @swamp/aws/scheduler/schedule_group` to see the
...
```bash
# Create a new schedule_group model
swamp model create @swamp/aws/scheduler/schedule_group my-schedule_group

# Edit the model to configure its properties
swamp model edit my-schedule_group

# Create the resource in AWS
swamp model method run my-schedule_group create

# Sync current state from AWS
swamp model method run my-schedule_group sync
```
