...
Use `swamp model type describe @swamp/aws/managedblockchain/accessor` to see the
...
```bash
# Create a new accessor model
swamp model create @swamp/aws/managedblockchain/accessor my-accessor

# Edit the model to configure its properties
swamp model edit my-accessor

# Create the resource in AWS
swamp model method run my-accessor create

# Sync current state from AWS
swamp model method run my-accessor sync
```
