...
Use `swamp model type describe @swamp/aws/athena/work-group` to see the full
...
```bash
# Create a new work-group model
swamp model create @swamp/aws/athena/work-group my-work-group

# Edit the model to configure its properties
swamp model edit my-work-group

# Create the resource in AWS
swamp model method run my-work-group create

# Sync current state from AWS
swamp model method run my-work-group sync
```
