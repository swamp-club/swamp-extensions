...
Use `swamp model type describe @swamp/aws/securityagent/agent_space` to see the
...
```bash
# Create a new agent_space model
swamp model create @swamp/aws/securityagent/agent_space my-agent_space

# Edit the model to configure its properties
swamp model edit my-agent_space

# Create the resource in AWS
swamp model method run my-agent_space create

# Sync current state from AWS
swamp model method run my-agent_space sync
```
