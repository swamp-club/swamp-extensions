...
Use `swamp model type describe @swamp/aws/iottwinmaker/component_type` to see
...
```bash
# Create a new component_type model
swamp model create @swamp/aws/iottwinmaker/component_type my-component_type

# Edit the model to configure its properties
swamp model edit my-component_type

# Create the resource in AWS
swamp model method run my-component_type create

# Sync current state from AWS
swamp model method run my-component_type sync
```
