...
Use `swamp model type describe @swamp/aws/rum/app_monitor` to see the full list
...
```bash
# Create a new app_monitor model
swamp model create @swamp/aws/rum/app_monitor my-app_monitor

# Edit the model to configure its properties
swamp model edit my-app_monitor

# Create the resource in AWS
swamp model method run my-app_monitor create

# Sync current state from AWS
swamp model method run my-app_monitor sync
```
