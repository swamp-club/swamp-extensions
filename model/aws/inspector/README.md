...
Use `swamp model type describe @swamp/aws/inspector/assessment_target` to see
...
```bash
# Create a new assessment_target model
swamp model create @swamp/aws/inspector/assessment_target my-assessment_target

# Edit the model to configure its properties
swamp model edit my-assessment_target

# Create the resource in AWS
swamp model method run my-assessment_target create

# Sync current state from AWS
swamp model method run my-assessment_target sync
```
