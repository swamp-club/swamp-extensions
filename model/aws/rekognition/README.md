...
Use `swamp model type describe @swamp/aws/rekognition/collection` to see the
...
swamp model create @swamp/aws/rekognition/collection my-collection

# Edit the model to configure its properties
swamp model edit my-collection

# Create the resource in AWS
swamp model method run my-collection create

# Sync current state from AWS
swamp model method run my-collection sync
```
