...
Use `swamp model type describe @swamp/aws/aiops/investigation_group` to see the
...
```bash
# Create a new investigation_group model
swamp model create @swamp/aws/aiops/investigation_group my-investigation_group

# Edit the model to configure its properties
swamp model edit my-investigation_group

# Create the resource in AWS
swamp model method run my-investigation_group create

# Sync current state from AWS
swamp model method run my-investigation_group sync
```
