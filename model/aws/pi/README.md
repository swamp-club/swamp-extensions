...
Use `swamp model type describe @swamp/aws/pi/perf_reports` to see the full list
...
```bash
# Create a new perf_reports model
swamp model create @swamp/aws/pi/perf_reports my-perf_reports

# Edit the model to configure its properties
swamp model edit my-perf_reports

# Create the resource in AWS
swamp model method run my-perf_reports create

# Sync current state from AWS
swamp model method run my-perf_reports sync
```
