...
// Auto-generated extension model for @swamp/aws/pi/perf-reports
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for PI PerfReports (AWS::PI::PerfReports).
 *
...
const GlobalArgsSchema = z.object({
  ...
  ServiceType: z.enum(["RDS", "DOCDB"]).describe(
    "The AWS service for which Performance Insights returns metrics. Valid values are RDS and DOCDB.",
  ),
  Identifier: z.string().min(0).max(256).regex(new RegExp("^[a-zA-Z0-9-]+$"))
    .describe(
...
/** Swamp extension model for PI PerfReports. Registered at `@swamp/aws/pi/perf-reports`. */
export const model = {
  type: "@swamp/aws/pi/perf-reports",
  version: "2026.09.23.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "PI PerfReports resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a PI PerfReports",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a PI PerfReports",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the PI PerfReports",
        ),
      }),
    ...
    delete: {
      description: "Delete a PI PerfReports",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the PI PerfReports",
        ),
    ...
    sync: {
      description: "Sync PI PerfReports state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List PI PerfReports resources",
      arguments: z.object({
