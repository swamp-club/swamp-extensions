...
Use `swamp model type describe @swamp/aws/s3objectlambda/access_point_policy` to
...
```bash
# Create a new access_point_policy model
swamp model create @swamp/aws/s3objectlambda/access_point_policy my-access_point_policy

# Edit the model to configure its properties
swamp model edit my-access_point_policy

# Create the resource in AWS
swamp model method run my-access_point_policy create

# Sync current state from AWS
swamp model method run my-access_point_policy sync
```
