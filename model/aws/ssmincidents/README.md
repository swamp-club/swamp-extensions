...
Use `swamp model type describe @swamp/aws/ssmincidents/replication_set` to see
...
```bash
# Create a new replication_set model
swamp model create @swamp/aws/ssmincidents/replication_set my-replication_set

# Edit the model to configure its properties
swamp model edit my-replication_set

# Create the resource in AWS
swamp model method run my-replication_set create

# Sync current state from AWS
swamp model method run my-replication_set sync
```
