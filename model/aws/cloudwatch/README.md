...
Use `swamp model type describe @swamp/aws/cloudwatch/alarm` to see the full list
...
```bash
# Create a new alarm model
swamp model create @swamp/aws/cloudwatch/alarm my-alarm

# Edit the model to configure its properties
swamp model edit my-alarm

# Create the resource in AWS
swamp model method run my-alarm create

# Sync current state from AWS
swamp model method run my-alarm sync
```
