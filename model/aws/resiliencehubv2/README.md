...
Use `swamp model type describe @swamp/aws/resiliencehubv2/policy` to see the
...
swamp model create @swamp/aws/resiliencehubv2/policy my-policy

# Edit the model to configure its properties
swamp model edit my-policy

# Create the resource in AWS
swamp model method run my-policy create

# Sync current state from AWS
swamp model method run my-policy sync
```
