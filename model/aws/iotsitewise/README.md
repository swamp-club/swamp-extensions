...
Use `swamp model type describe @swamp/aws/iotsitewise/access_policy` to see the
...
swamp model create @swamp/aws/iotsitewise/access_policy my-access_policy
