...
Use `swamp model type describe @swamp/aws/securitylake/aws_log_source` to see
...
```bash
# Create a new aws_log_source model
swamp model create @swamp/aws/securitylake/aws_log_source my-aws_log_source

# Edit the model to configure its properties
swamp model edit my-aws_log_source

# Create the resource in AWS
swamp model method run my-aws_log_source create

# Sync current state from AWS
swamp model method run my-aws_log_source sync
```
