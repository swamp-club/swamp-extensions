...
Use `swamp model type describe @swamp/aws/ivschat/logging_configuration` to see
...
```bash
# Create a new logging_configuration model
swamp model create @swamp/aws/ivschat/logging_configuration my-logging_configuration

# Edit the model to configure its properties
swamp model edit my-logging_configuration

# Create the resource in AWS
swamp model method run my-logging_configuration create

# Sync current state from AWS
swamp model method run my-logging_configuration sync
```
