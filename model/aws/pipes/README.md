...
Use `swamp model type describe @swamp/aws/pipes/pipe` to see the full list of
...
```bash
# Create a new pipe model
swamp model create @swamp/aws/pipes/pipe my-pipe

# Edit the model to configure its properties
swamp model edit my-pipe

# Create the resource in AWS
swamp model method run my-pipe create

# Sync current state from AWS
swamp model method run my-pipe sync
```
