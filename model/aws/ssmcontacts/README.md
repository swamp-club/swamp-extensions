...
Use `swamp model type describe @swamp/aws/ssmcontacts/contact_channel` to see
...
```bash
# Create a new contact_channel model
swamp model create @swamp/aws/ssmcontacts/contact_channel my-contact_channel

# Edit the model to configure its properties
swamp model edit my-contact_channel

# Create the resource in AWS
swamp model method run my-contact_channel create

# Sync current state from AWS
swamp model method run my-contact_channel sync
```
