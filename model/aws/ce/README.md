...
Use `swamp model type describe @swamp/aws/ce/anomaly_monitor` to see the full
...
```bash
# Create a new anomaly_monitor model
swamp model create @swamp/aws/ce/anomaly_monitor my-anomaly_monitor

# Edit the model to configure its properties
swamp model edit my-anomaly_monitor

# Create the resource in AWS
swamp model method run my-anomaly_monitor create

# Sync current state from AWS
swamp model method run my-anomaly_monitor sync
```
