...
Use `swamp model type describe @swamp/aws/healthimaging/datastore` to see the
...
```bash
# Create a new datastore model
swamp model create @swamp/aws/healthimaging/datastore my-datastore

# Edit the model to configure its properties
swamp model edit my-datastore

# Create the resource in AWS
swamp model method run my-datastore create

# Sync current state from AWS
swamp model method run my-datastore sync
```
