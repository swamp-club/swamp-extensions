...
Use `swamp model type describe @swamp/aws/medialive/channel_placement_group` to
...
```bash
# Create a new channel_placement_group model
swamp model create @swamp/aws/medialive/channel_placement_group my-channel_placement_group

# Edit the model to configure its properties
swamp model edit my-channel_placement_group

# Create the resource in AWS
swamp model method run my-channel_placement_group create

# Sync current state from AWS
swamp model method run my-channel_placement_group sync
```
