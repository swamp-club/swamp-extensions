...
Use `swamp model type describe @swamp/aws/pinpoint/in_app_template` to see the
...
```bash
# Create a new in_app_template model
swamp model create @swamp/aws/pinpoint/in_app_template my-in_app_template

# Edit the model to configure its properties
swamp model edit my-in_app_template

# Create the resource in AWS
swamp model method run my-in_app_template create

# Sync current state from AWS
swamp model method run my-in_app_template sync
```
