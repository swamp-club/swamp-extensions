...
Use `swamp model type describe @swamp/aws/mpa/approval_team` to see the full
...
```bash
# Create a new approval_team model
swamp model create @swamp/aws/mpa/approval_team my-approval_team

# Edit the model to configure its properties
swamp model edit my-approval_team

# Create the resource in AWS
swamp model method run my-approval_team create

# Sync current state from AWS
swamp model method run my-approval_team sync
```
