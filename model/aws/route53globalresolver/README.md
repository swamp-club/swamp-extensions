...
AWS ROUTE53GLOBALRESOLVER resources.
...
Use `swamp model type describe @swamp/aws/route53globalresolver/access_source`
...
```bash
# Create a new access_source model
swamp model create @swamp/aws/route53globalresolver/access_source my-access_source

# Edit the model to configure its properties
swamp model edit my-access_source

# Create the resource in AWS
swamp model method run my-access_source create

# Sync current state from AWS
swamp model method run my-access_source sync
```
