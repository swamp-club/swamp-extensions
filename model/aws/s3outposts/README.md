...
Use `swamp model type describe @swamp/aws/s3outposts/access_point` to see the
...
```bash
# Create a new access_point model
swamp model create @swamp/aws/s3outposts/access_point my-access_point

# Edit the model to configure its properties
swamp model edit my-access_point

# Create the resource in AWS
swamp model method run my-access_point create

# Sync current state from AWS
swamp model method run my-access_point sync
```
