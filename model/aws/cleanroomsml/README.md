...
Use
`swamp model type describe @swamp/aws/cleanroomsml/configured_model_algorithm_association`
...
```bash
# Create a new configured_model_algorithm_association model
swamp model create @swamp/aws/cleanroomsml/configured_model_algorithm_association my-configured_model_algorithm_association

# Edit the model to configure its properties
swamp model edit my-configured_model_algorithm_association

# Create the resource in AWS
swamp model method run my-configured_model_algorithm_association create

# Sync current state from AWS
swamp model method run my-configured_model_algorithm_association sync
```
