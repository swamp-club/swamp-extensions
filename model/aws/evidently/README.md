...
Use `swamp model type describe @swamp/aws/evidently/experiment` to see the full
...
swamp model create @swamp/aws/evidently/experiment my-experiment

# Edit the model to configure its properties
swamp model edit my-experiment

# Create the resource in AWS
swamp model method run my-experiment create

# Sync current state from AWS
swamp model method run my-experiment sync
```
