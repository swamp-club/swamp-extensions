...
Use `swamp model type describe @swamp/aws/secretsmanager/secret` to see the full
...
swamp model create @swamp/aws/secretsmanager/secret my-secret

# Edit the model to configure its properties
swamp model edit my-secret

# Create the resource in AWS
swamp model method run my-secret create

# Sync current state from AWS
swamp model method run my-secret sync
```
