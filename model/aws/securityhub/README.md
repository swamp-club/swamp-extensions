...
Use `swamp model type describe @swamp/aws/securityhub/aggregator_v2` to see the
...
```bash
# Create a new aggregator_v2 model
swamp model create @swamp/aws/securityhub/aggregator_v2 my-aggregator_v2

# Edit the model to configure its properties
swamp model edit my-aggregator_v2

# Create the resource in AWS
swamp model method run my-aggregator_v2 create

# Sync current state from AWS
swamp model method run my-aggregator_v2 sync
```
