...
Use `swamp model type describe @swamp/aws/lex/bot_alias` to see the full list of
...
```bash
# Create a new bot_alias model
swamp model create @swamp/aws/lex/bot_alias my-bot_alias

# Edit the model to configure its properties
swamp model edit my-bot_alias

# Create the resource in AWS
swamp model method run my-bot_alias create

# Sync current state from AWS
swamp model method run my-bot_alias sync
```
