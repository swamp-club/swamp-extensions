...
Use `swamp model type describe @swamp/aws/appflow/connector_profile` to see the
...
```bash
# Create a new connector_profile model
swamp model create @swamp/aws/appflow/connector_profile my-connector_profile

# Edit the model to configure its properties
swamp model edit my-connector_profile

# Create the resource in AWS
swamp model method run my-connector_profile create

# Sync current state from AWS
swamp model method run my-connector_profile sync
```
