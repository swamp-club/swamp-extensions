...
Use `swamp model type describe @swamp/aws/bcm/dashboard` to see the full list of
...
swamp model create @swamp/aws/bcm/dashboard my-dashboard

# Edit the model to configure its properties
swamp model edit my-dashboard

# Create the resource in AWS
swamp model method run my-dashboard create
