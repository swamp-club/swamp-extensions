...
Use `swamp model type describe @swamp/aws/iam/role` to see the full list of
...
swamp model create @swamp/aws/iam/role my-role

# Edit the model to configure its properties
swamp model edit my-role

# Create the resource in AWS
swamp model method run my-role create

# Sync current state from AWS
swamp model method run my-role sync
```
