...
AWS VERIFIEDPERMISSIONS resources.
...
Use `swamp model type describe @swamp/aws/verifiedpermissions/identity_source`
...
```bash
# Create a new identity_source model
swamp model create @swamp/aws/verifiedpermissions/identity_source my-identity_source

# Edit the model to configure its properties
swamp model edit my-identity_source

# Create the resource in AWS
swamp model method run my-identity_source create

# Sync current state from AWS
swamp model method run my-identity_source sync
```
