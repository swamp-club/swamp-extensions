...
Use `swamp model type describe @swamp/aws/route53/hosted-zone` to see the full
...
```bash
# Create a new hosted-zone model
swamp model create @swamp/aws/route53/hosted-zone my-hosted-zone

# Edit the model to configure its properties
swamp model edit my-hosted-zone

# Create the resource in AWS
swamp model method run my-hosted-zone create

# Sync current state from AWS
swamp model method run my-hosted-zone sync
```
