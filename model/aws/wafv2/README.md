...
Use `swamp model type describe @swamp/aws/wafv2/web-acl` to see the full list of
...
```bash
# Create a new web-acl model
swamp model create @swamp/aws/wafv2/web-acl my-web-acl

# Edit the model to configure its properties
swamp model edit my-web-acl

# Create the resource in AWS
swamp model method run my-web-acl create

# Sync current state from AWS
swamp model method run my-web-acl sync
```
