...
Use `swamp model type describe @swamp/aws/accessanalyzer/analyzer` to see the
...
```bash
# Create a new analyzer model
swamp model create @swamp/aws/accessanalyzer/analyzer my-analyzer

# Edit the model to configure its properties
swamp model edit my-analyzer

# Create the resource in AWS
swamp model method run my-analyzer create

# Sync current state from AWS
swamp model method run my-analyzer sync
```
