...
Use `swamp model type describe @swamp/aws/notifications/channel_association` to
...
```bash
# Create a new channel_association model
swamp model create @swamp/aws/notifications/channel_association my-channel_association

# Edit the model to configure its properties
swamp model edit my-channel_association

# Create the resource in AWS
swamp model method run my-channel_association create

# Sync current state from AWS
swamp model method run my-channel_association sync
```
