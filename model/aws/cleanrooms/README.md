...
Use `swamp model type describe @swamp/aws/cleanrooms/analysis_template` to see
...
```bash
# Create a new analysis_template model
swamp model create @swamp/aws/cleanrooms/analysis_template my-analysis_template

# Edit the model to configure its properties
swamp model edit my-analysis_template

# Create the resource in AWS
swamp model method run my-analysis_template create

# Sync current state from AWS
swamp model method run my-analysis_template sync
```
