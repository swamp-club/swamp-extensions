...
AWS APPLICATIONINSIGHTS resources.
...
Use `swamp model type describe @swamp/aws/applicationinsights/application` to
...
swamp model create @swamp/aws/applicationinsights/application my-application
