...
Use
`swamp model type describe @swamp/aws/ses/configuration_set_event_destination`
...
```bash
# Create a new configuration_set_event_destination model
swamp model create @swamp/aws/ses/configuration_set_event_destination my-configuration_set_event_destination

# Edit the model to configure its properties
swamp model edit my-configuration_set_event_destination

# Create the resource in AWS
swamp model method run my-configuration_set_event_destination create

# Sync current state from AWS
swamp model method run my-configuration_set_event_destination sync
```
