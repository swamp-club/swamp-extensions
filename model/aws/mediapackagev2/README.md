...
Use `swamp model type describe @swamp/aws/mediapackagev2/channel_group` to see
...
```bash
# Create a new channel_group model
swamp model create @swamp/aws/mediapackagev2/channel_group my-channel_group

# Edit the model to configure its properties
swamp model edit my-channel_group

# Create the resource in AWS
swamp model method run my-channel_group create

# Sync current state from AWS
swamp model method run my-channel_group sync
```
