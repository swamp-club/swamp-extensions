...
Use `swamp model type describe @swamp/aws/eventsv2/event_bus` to see the full
...
```bash
# Create a new event_bus model
swamp model create @swamp/aws/eventsv2/event_bus my-event_bus

# Edit the model to configure its properties
swamp model edit my-event_bus

# Create the resource in AWS
swamp model method run my-event_bus create

# Sync current state from AWS
swamp model method run my-event_bus sync
```
