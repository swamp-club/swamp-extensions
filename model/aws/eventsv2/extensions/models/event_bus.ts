...
// Auto-generated extension model for @swamp/aws/eventsv2/event-bus
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any no-control-regex

/**
 * Swamp extension model for EventsV2 EventBus (AWS::EventsV2::EventBus).
 *
...
const GlobalArgsSchema = z.object({
  ...
  StorageConfiguration: z.object({
    RetentionPeriodInDays: z.number().int().min(1).max(365).describe(
  ...
  Tags: z.array(TagSchema).describe("The tags assigned to the event bus.")
    .optional(),
});
...
/** Swamp extension model for EventsV2 EventBus. Registered at `@swamp/aws/eventsv2/event-bus`. */
export const model = {
  type: "@swamp/aws/eventsv2/event-bus",
  version: "2026.09.25.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "EventsV2 EventBus resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a EventsV2 EventBus",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a EventsV2 EventBus",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the EventsV2 EventBus",
        ),
      }),
    ...
    update: {
      description: "Update a EventsV2 EventBus",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a EventsV2 EventBus",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the EventsV2 EventBus",
        ),
    ...
    sync: {
      description: "Sync EventsV2 EventBus state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List EventsV2 EventBus resources",
      arguments: z.object({
