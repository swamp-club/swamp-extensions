...
Use `swamp model type describe @swamp/aws/awsexternalanthropic/workspace` to see
...
swamp model create @swamp/aws/awsexternalanthropic/workspace my-workspace

# Edit the model to configure its properties
swamp model edit my-workspace

# Create the resource in AWS
swamp model method run my-workspace create

# Sync current state from AWS
swamp model method run my-workspace sync
```
