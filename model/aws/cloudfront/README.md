...
Use `swamp model type describe @swamp/aws/cloudfront/distribution` to see the
...
swamp model create @swamp/aws/cloudfront/distribution my-distribution

# Edit the model to configure its properties
swamp model edit my-distribution

# Create the resource in AWS
swamp model method run my-distribution create

# Sync current state from AWS
swamp model method run my-distribution sync
```
