...
Use `swamp model type describe @swamp/aws/sqs/queue` to see the full list of
...
swamp model create @swamp/aws/sqs/queue my-queue

# Edit the model to configure its properties
swamp model edit my-queue

# Create the resource in AWS
swamp model method run my-queue create

# Sync current state from AWS
swamp model method run my-queue sync
```
