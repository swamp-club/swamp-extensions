...
Use `swamp model type describe @swamp/aws/macie/allow_list` to see the full list
...
```bash
# Create a new allow_list model
swamp model create @swamp/aws/macie/allow_list my-allow_list

# Edit the model to configure its properties
swamp model edit my-allow_list

# Create the resource in AWS
swamp model method run my-allow_list create

# Sync current state from AWS
swamp model method run my-allow_list sync
```
