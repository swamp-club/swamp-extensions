...
Use `swamp model type describe @swamp/aws/iotcoredeviceadvisor/suite_definition`
...
```bash
# Create a new suite_definition model
swamp model create @swamp/aws/iotcoredeviceadvisor/suite_definition my-suite_definition

# Edit the model to configure its properties
swamp model edit my-suite_definition

# Create the resource in AWS
swamp model method run my-suite_definition create

# Sync current state from AWS
swamp model method run my-suite_definition sync
```
