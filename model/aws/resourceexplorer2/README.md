...
Use
`swamp model type describe @swamp/aws/resourceexplorer2/default_view_association`
...
```bash
# Create a new default_view_association model
swamp model create @swamp/aws/resourceexplorer2/default_view_association my-default_view_association

# Edit the model to configure its properties
swamp model edit my-default_view_association

# Create the resource in AWS
swamp model method run my-default_view_association create

# Sync current state from AWS
swamp model method run my-default_view_association sync
```
