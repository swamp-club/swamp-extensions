...
AWS OPENSEARCHSERVICE resources.
...
Use `swamp model type describe @swamp/aws/opensearchservice/application` to see
...
swamp model create @swamp/aws/opensearchservice/application my-application
