...
Use `swamp model type describe @swamp/aws/elasticbeanstalk/application_version`
...
```bash
# Create a new application_version model
swamp model create @swamp/aws/elasticbeanstalk/application_version my-application_version

# Edit the model to configure its properties
swamp model edit my-application_version

# Create the resource in AWS
swamp model method run my-application_version create

# Sync current state from AWS
swamp model method run my-application_version sync
```
