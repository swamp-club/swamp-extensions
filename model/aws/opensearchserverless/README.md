...
AWS OPENSEARCHSERVERLESS resources.
...
Use `swamp model type describe @swamp/aws/opensearchserverless/access_policy` to
...
```bash
# Create a new access_policy model
swamp model create @swamp/aws/opensearchserverless/access_policy my-access_policy

# Edit the model to configure its properties
swamp model edit my-access_policy

# Create the resource in AWS
swamp model method run my-access_policy create

# Sync current state from AWS
swamp model method run my-access_policy sync
```
