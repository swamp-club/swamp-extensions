...
Use `swamp model type describe @swamp/aws/cloudformation/stack` to see the full
...
swamp model create @swamp/aws/cloudformation/stack my-stack

# Edit the model to configure its properties
swamp model edit my-stack

# Create the resource in AWS
swamp model method run my-stack create

# Sync current state from AWS
swamp model method run my-stack sync
```
