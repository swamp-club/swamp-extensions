...
Use `swamp model type describe @swamp/aws/chatbot/custom_action` to see the full
...
```bash
# Create a new custom_action model
swamp model create @swamp/aws/chatbot/custom_action my-custom_action

# Edit the model to configure its properties
swamp model edit my-custom_action

# Create the resource in AWS
swamp model method run my-custom_action create

# Sync current state from AWS
swamp model method run my-custom_action sync
```
