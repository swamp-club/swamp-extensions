...
Use `swamp model type describe @swamp/aws/msk/batch_scram_secret` to see the
...
```bash
# Create a new batch_scram_secret model
swamp model create @swamp/aws/msk/batch_scram_secret my-batch_scram_secret

# Edit the model to configure its properties
swamp model edit my-batch_scram_secret

# Create the resource in AWS
swamp model method run my-batch_scram_secret create

# Sync current state from AWS
swamp model method run my-batch_scram_secret sync
```
