...
Use `swamp model type describe @swamp/aws/cases/case_rule` to see the full list
...
```bash
# Create a new case_rule model
swamp model create @swamp/aws/cases/case_rule my-case_rule

# Edit the model to configure its properties
swamp model edit my-case_rule

# Create the resource in AWS
swamp model method run my-case_rule create

# Sync current state from AWS
swamp model method run my-case_rule sync
```
