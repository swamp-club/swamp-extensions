...
Use `swamp model type describe @swamp/aws/supportapp/account_alias` to see the
...
```bash
# Create a new account_alias model
swamp model create @swamp/aws/supportapp/account_alias my-account_alias

# Edit the model to configure its properties
swamp model edit my-account_alias

# Create the resource in AWS
swamp model method run my-account_alias create

# Sync current state from AWS
swamp model method run my-account_alias sync
```
