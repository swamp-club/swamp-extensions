...
Use `swamp model type describe @swamp/aws/smsvoice/configuration_set` to see the
...
```bash
# Create a new configuration_set model
swamp model create @swamp/aws/smsvoice/configuration_set my-configuration_set

# Edit the model to configure its properties
swamp model edit my-configuration_set

# Create the resource in AWS
swamp model method run my-configuration_set create

# Sync current state from AWS
swamp model method run my-configuration_set sync
```
