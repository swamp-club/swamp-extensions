...
AWS CODESTARCONNECTIONS resources.
...
Use `swamp model type describe @swamp/aws/codestarconnections/connection` to see
...
swamp model create @swamp/aws/codestarconnections/connection my-connection

# Edit the model to configure its properties
swamp model edit my-connection

# Create the resource in AWS
swamp model method run my-connection create

# Sync current state from AWS
swamp model method run my-connection sync
```
