...
Use `swamp model type describe @swamp/aws/kinesisvideo/signaling_channel` to see
...
```bash
# Create a new signaling_channel model
swamp model create @swamp/aws/kinesisvideo/signaling_channel my-signaling_channel

# Edit the model to configure its properties
swamp model edit my-signaling_channel

# Create the resource in AWS
swamp model method run my-signaling_channel create

# Sync current state from AWS
swamp model method run my-signaling_channel sync
```
