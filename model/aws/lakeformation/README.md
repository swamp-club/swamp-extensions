...
Use `swamp model type describe @swamp/aws/lakeformation/data_cells_filter` to
...
```bash
# Create a new data_cells_filter model
swamp model create @swamp/aws/lakeformation/data_cells_filter my-data_cells_filter

# Edit the model to configure its properties
swamp model edit my-data_cells_filter

# Create the resource in AWS
swamp model method run my-data_cells_filter create

# Sync current state from AWS
swamp model method run my-data_cells_filter sync
```
