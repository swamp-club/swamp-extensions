...
Use `swamp model type describe @swamp/aws/synthetics/canary` to see the full
...
```bash
# Create a new canary model
swamp model create @swamp/aws/synthetics/canary my-canary

# Edit the model to configure its properties
swamp model edit my-canary

# Create the resource in AWS
swamp model method run my-canary create

# Sync current state from AWS
swamp model method run my-canary sync
```
