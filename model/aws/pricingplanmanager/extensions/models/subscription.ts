...
// Auto-generated extension model for @swamp/aws/pricingplanmanager/subscription
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for PricingPlanManager Subscription (AWS::PricingPlanManager::Subscription).
 *
...
const GlobalArgsSchema = z.object({
  ...
  PlanFamily: z.enum(["CloudFront"]).describe(
...
export const model = {
  ...
  resources: {
    state: {
      description: "PricingPlanManager Subscription resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a PricingPlanManager Subscription",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a PricingPlanManager Subscription",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the PricingPlanManager Subscription",
        ),
      }),
    ...
    update: {
      description: "Update a PricingPlanManager Subscription",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a PricingPlanManager Subscription",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the PricingPlanManager Subscription",
        ),
    ...
    sync: {
      description: "Sync PricingPlanManager Subscription state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List PricingPlanManager Subscription resources",
      arguments: z.object({
