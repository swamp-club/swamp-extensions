...
Use `swamp model type describe @swamp/aws/pricingplanmanager/subscription` to
...
swamp model create @swamp/aws/pricingplanmanager/subscription my-subscription

# Edit the model to configure its properties
swamp model edit my-subscription

# Create the resource in AWS
swamp model method run my-subscription create

# Sync current state from AWS
swamp model method run my-subscription sync
```
