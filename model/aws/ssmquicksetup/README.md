...
Use `swamp model type describe @swamp/aws/ssmquicksetup/configuration_manager`
...
```bash
# Create a new configuration_manager model
swamp model create @swamp/aws/ssmquicksetup/configuration_manager my-configuration_manager

# Edit the model to configure its properties
swamp model edit my-configuration_manager

# Create the resource in AWS
swamp model method run my-configuration_manager create

# Sync current state from AWS
swamp model method run my-configuration_manager sync
```
