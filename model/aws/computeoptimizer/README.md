...
Use `swamp model type describe @swamp/aws/computeoptimizer/automation_rule` to
...
```bash
# Create a new automation_rule model
swamp model create @swamp/aws/computeoptimizer/automation_rule my-automation_rule

# Edit the model to configure its properties
swamp model edit my-automation_rule

# Create the resource in AWS
swamp model method run my-automation_rule create

# Sync current state from AWS
swamp model method run my-automation_rule sync
```
