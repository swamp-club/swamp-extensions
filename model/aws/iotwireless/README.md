...
Use `swamp model type describe @swamp/aws/iotwireless/destination` to see the
...
swamp model create @swamp/aws/iotwireless/destination my-destination

# Edit the model to configure its properties
swamp model edit my-destination

# Create the resource in AWS
swamp model method run my-destination create

# Sync current state from AWS
swamp model method run my-destination sync
```
