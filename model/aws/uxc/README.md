...
Use `swamp model type describe @swamp/aws/uxc/account_customization` to see the
...
```bash
# Create a new account_customization model
swamp model create @swamp/aws/uxc/account_customization my-account_customization

# Edit the model to configure its properties
swamp model edit my-account_customization

# Create the resource in AWS
swamp model method run my-account_customization create

# Sync current state from AWS
swamp model method run my-account_customization sync
```
