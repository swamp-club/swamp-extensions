...
Use `swamp model type describe @swamp/aws/simspaceweaver/simulation` to see the
...
swamp model create @swamp/aws/simspaceweaver/simulation my-simulation

# Edit the model to configure its properties
swamp model edit my-simulation

# Create the resource in AWS
swamp model method run my-simulation create

# Sync current state from AWS
swamp model method run my-simulation sync
```
