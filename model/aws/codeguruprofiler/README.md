...
Use `swamp model type describe @swamp/aws/codeguruprofiler/profiling_group` to
...
```bash
# Create a new profiling_group model
swamp model create @swamp/aws/codeguruprofiler/profiling_group my-profiling_group

# Edit the model to configure its properties
swamp model edit my-profiling_group

# Create the resource in AWS
swamp model method run my-profiling_group create

# Sync current state from AWS
swamp model method run my-profiling_group sync
```
