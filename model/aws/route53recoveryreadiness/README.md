...
Use `swamp model type describe @swamp/aws/route53recoveryreadiness/cell` to see
...
swamp model create @swamp/aws/route53recoveryreadiness/cell my-cell

# Edit the model to configure its properties
swamp model edit my-cell

# Create the resource in AWS
swamp model method run my-cell create

# Sync current state from AWS
swamp model method run my-cell sync
```
