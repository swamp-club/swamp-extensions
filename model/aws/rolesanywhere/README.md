...
Use `swamp model type describe @swamp/aws/rolesanywhere/crl` to see the full
...
swamp model create @swamp/aws/rolesanywhere/crl my-crl

# Edit the model to configure its properties
swamp model edit my-crl

# Create the resource in AWS
swamp model method run my-crl create

# Sync current state from AWS
swamp model method run my-crl sync
```
