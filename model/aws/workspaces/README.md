...
Use `swamp model type describe @swamp/aws/workspaces/connection_alias` to see
...
```bash
# Create a new connection_alias model
swamp model create @swamp/aws/workspaces/connection_alias my-connection_alias

# Edit the model to configure its properties
swamp model edit my-connection_alias

# Create the resource in AWS
swamp model method run my-connection_alias create

# Sync current state from AWS
swamp model method run my-connection_alias sync
```
