...
Use `swamp model type describe @swamp/aws/apigateway/rest-api` to see the full
...
```bash
# Create a new rest-api model
swamp model create @swamp/aws/apigateway/rest-api my-rest-api

# Edit the model to configure its properties
swamp model edit my-rest-api

# Create the resource in AWS
swamp model method run my-rest-api create

# Sync current state from AWS
swamp model method run my-rest-api sync
```
