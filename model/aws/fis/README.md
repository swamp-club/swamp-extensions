...
Use `swamp model type describe @swamp/aws/fis/experiment_template` to see the
...
```bash
# Create a new experiment_template model
swamp model create @swamp/aws/fis/experiment_template my-experiment_template

# Edit the model to configure its properties
swamp model edit my-experiment_template

# Create the resource in AWS
swamp model method run my-experiment_template create

# Sync current state from AWS
swamp model method run my-experiment_template sync
```
