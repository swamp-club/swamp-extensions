...
Use `swamp model type describe @swamp/aws/config/aggregation_authorization` to
...
```bash
# Create a new aggregation_authorization model
swamp model create @swamp/aws/config/aggregation_authorization my-aggregation_authorization

# Edit the model to configure its properties
swamp model edit my-aggregation_authorization

# Create the resource in AWS
swamp model method run my-aggregation_authorization create

# Sync current state from AWS
swamp model method run my-aggregation_authorization sync
```
