...
// Auto-generated extension model for @swamp/aws/config/configuration-recorder
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Config ConfigurationRecorder (AWS::Config::ConfigurationRecorder).
 *
...
const RecordingStrategySchema = z.object({
  UseOnly: z.string(),
});

const ExclusionByResourceTypesSchema = z.object({
  ResourceTypes: z.array(z.string()).describe(
    "A comma-separated list of resource types to exclude from recording by the configuration recorder.",
  ),
});

const RecordingModeOverrideSchema = z.object({
  ResourceTypes: z.array(z.string()).describe(
    "A comma-separated list that specifies which resource types AWS Config includes in the override.",
  ),
  RecordingFrequency: z.string().describe(
...
const GlobalArgsSchema = z.object({
  ...
  RecordingGroup: z.object({
    IncludeGlobalResourceTypes: z.boolean().describe(
    ...
    RecordingStrategy: RecordingStrategySchema.describe(
      "An object that specifies the recording strategy for the configuration recorder.",
    ).optional(),
    ExclusionByResourceTypes: ExclusionByResourceTypesSchema.describe(
      "An object that specifies how AWS Config excludes resource types from being recorded by the configuration recorder.",
    ).optional(),
    AllSupported: z.boolean().describe(
  ...
  RecordingMode: z.object({
    RecordingModeOverrides: z.array(RecordingModeOverrideSchema).describe(
  ...
  StartedOnCreate: z.boolean().describe(
...
const StateSchema = z.object({
  ...
  RecordingGroup: z.object({
    IncludeGlobalResourceTypes: z.boolean(),
    ResourceTypes: z.array(z.string()),
    RecordingStrategy: RecordingStrategySchema,
    ExclusionByResourceTypes: ExclusionByResourceTypesSchema,
    AllSupported: z.boolean(),
  }).optional(),
  RecordingMode: z.object({
    RecordingModeOverrides: z.array(RecordingModeOverrideSchema),
    RecordingFrequency: z.string(),
  }).optional(),
  RoleARN: z.string().optional(),
  StartedOnCreate: z.boolean().optional(),
}).passthrough();
...
/** Swamp extension model for Config ConfigurationRecorder. Registered at `@swamp/aws/config/configuration-recorder`. */
export const model = {
  type: "@swamp/aws/config/configuration-recorder",
  version: "2026.09.25.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "Config ConfigurationRecorder resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Config ConfigurationRecorder",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Config ConfigurationRecorder",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Config ConfigurationRecorder",
        ),
      }),
    ...
    update: {
      description: "Update a Config ConfigurationRecorder",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Config ConfigurationRecorder",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Config ConfigurationRecorder",
        ),
    ...
    sync: {
      description: "Sync Config ConfigurationRecorder state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Config ConfigurationRecorder resources",
      arguments: z.object({
