...
Use `swamp model type describe @swamp/aws/partnercentral/connection_preferences`
...
```bash
# Create a new connection_preferences model
swamp model create @swamp/aws/partnercentral/connection_preferences my-connection_preferences

# Edit the model to configure its properties
swamp model edit my-connection_preferences

# Create the resource in AWS
swamp model method run my-connection_preferences create

# Sync current state from AWS
swamp model method run my-connection_preferences sync
```
