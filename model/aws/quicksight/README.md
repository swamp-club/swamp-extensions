...
Use `swamp model type describe @swamp/aws/quicksight/action_connector` to see
...
```bash
# Create a new action_connector model
swamp model create @swamp/aws/quicksight/action_connector my-action_connector

# Edit the model to configure its properties
swamp model edit my-action_connector

# Create the resource in AWS
swamp model method run my-action_connector create

# Sync current state from AWS
swamp model method run my-action_connector sync
```
