...
Use `swamp model type describe @swamp/aws/resiliencehub/app` to see the full
...
swamp model create @swamp/aws/resiliencehub/app my-app

# Edit the model to configure its properties
swamp model edit my-app

# Create the resource in AWS
swamp model method run my-app create
