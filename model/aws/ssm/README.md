...
Use `swamp model type describe @swamp/aws/ssm/association` to see the full list
...
swamp model create @swamp/aws/ssm/association my-association

# Edit the model to configure its properties
swamp model edit my-association

# Create the resource in AWS
swamp model method run my-association create

# Sync current state from AWS
swamp model method run my-association sync
```
