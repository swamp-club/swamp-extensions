...
Use `swamp model type describe @swamp/aws/location/apikey` to see the full list
...
```bash
# Create a new apikey model
swamp model create @swamp/aws/location/apikey my-apikey

# Edit the model to configure its properties
swamp model edit my-apikey

# Create the resource in AWS
swamp model method run my-apikey create

# Sync current state from AWS
swamp model method run my-apikey sync
```
