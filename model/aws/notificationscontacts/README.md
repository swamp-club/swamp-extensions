...
Use `swamp model type describe @swamp/aws/notificationscontacts/email_contact`
...
```bash
# Create a new email_contact model
swamp model create @swamp/aws/notificationscontacts/email_contact my-email_contact

# Edit the model to configure its properties
swamp model edit my-email_contact

# Create the resource in AWS
swamp model method run my-email_contact create

# Sync current state from AWS
swamp model method run my-email_contact sync
```
