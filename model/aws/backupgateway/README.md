...
Use `swamp model type describe @swamp/aws/backupgateway/hypervisor` to see the
...
```bash
# Create a new hypervisor model
swamp model create @swamp/aws/backupgateway/hypervisor my-hypervisor

# Edit the model to configure its properties
swamp model edit my-hypervisor

# Create the resource in AWS
swamp model method run my-hypervisor create

# Sync current state from AWS
swamp model method run my-hypervisor sync
```
