...
Use `swamp model type describe @swamp/aws/bcmdataexports/export` to see the full
...
swamp model create @swamp/aws/bcmdataexports/export my-export

# Edit the model to configure its properties
swamp model edit my-export

# Create the resource in AWS
swamp model method run my-export create

# Sync current state from AWS
swamp model method run my-export sync
```
