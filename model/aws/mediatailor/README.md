...
Use `swamp model type describe @swamp/aws/mediatailor/channel_policy` to see the
...
```bash
# Create a new channel_policy model
swamp model create @swamp/aws/mediatailor/channel_policy my-channel_policy

# Edit the model to configure its properties
swamp model edit my-channel_policy

# Create the resource in AWS
swamp model method run my-channel_policy create

# Sync current state from AWS
swamp model method run my-channel_policy sync
```
