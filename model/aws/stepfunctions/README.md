...
Use `swamp model type describe @swamp/aws/stepfunctions/state-machine` to see
...
```bash
# Create a new state-machine model
swamp model create @swamp/aws/stepfunctions/state-machine my-state-machine

# Edit the model to configure its properties
swamp model edit my-state-machine

# Create the resource in AWS
swamp model method run my-state-machine create

# Sync current state from AWS
swamp model method run my-state-machine sync
```
