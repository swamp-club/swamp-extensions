...
AWS WORKSPACESTHINCLIENT resources.
...
Use `swamp model type describe @swamp/aws/workspacesthinclient/environment` to
...
swamp model create @swamp/aws/workspacesthinclient/environment my-environment

# Edit the model to configure its properties
swamp model edit my-environment

# Create the resource in AWS
swamp model method run my-environment create

# Sync current state from AWS
swamp model method run my-environment sync
```
